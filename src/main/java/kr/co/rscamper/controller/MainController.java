...
//        urlBuilder.append("&" + URLEncoder.encode("depPlaceId","UTF-8") + "=" + mainService.selectDepPlaceId(sub.getDepPlaceId())); 
//        urlBuilder.append("&" + URLEncoder.encode("arrPlaceId","UTF-8") + "=" + mainService.selectArrPlaceId(sub.getArrPlaceId()));
