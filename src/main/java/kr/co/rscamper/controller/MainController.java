...
//	private BenefitService service;
	...
	public @ResponseBody StringBuilder api(SubwayVO sub)throws Exception {
        ...
        urlBuilder.append("&" + URLEncoder.encode("depPlaceId","UTF-8") + "=" + sub.getDepPlaceId()); 
        urlBuilder.append("&" + URLEncoder.encode("arrPlaceId","UTF-8") + "=" + sub.getArrPlaceId());
